...
Route::post('/insertcate',[first::class,"insertcate"]);
Route::get('/pie',[first::class,'chart']);
Route::get('/addcategory',[first::class,'category']);
Route::get('/editcate/{id}',[first::class,'editcate']);
Route::post('/updatecate',[first::class,'updatecate']);
Route::get('/delecate/{id}',[first::class,'delecate']);
Route::get('/addproduct',[first::class,'product']);
Route::get('/products',[first::class,'showpro']);
